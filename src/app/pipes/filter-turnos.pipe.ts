  ...
  transform(value: any, arg: any): any {
    ...
    if(arg != null){
      ...
      for (const post of value) {
        ...
        || post.historiaClinica.clave3.indexOf(arg) > -1 || post.historiaClinica.clave2.indexOf(arg) > -1
        || post.historiaClinica.clave4.indexOf(arg) > -1 || post.historiaClinica.clave5.indexOf(arg) > -1
